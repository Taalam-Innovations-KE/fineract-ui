  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="mx-auto max-w-7xl space-y-12">
        ...
        {/* Cards */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-foreground">Card Surfaces</h2>

          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-lg border border-border bg-card p-6 space-y-2">
              <h3 className="font-semibold text-card-foreground">Account Balance</h3>
              <p className="text-3xl font-bold tabular-nums">$42,891.50</p>
              <p className="text-sm text-muted-foreground">Available balance</p>
            </div>

            <div className="rounded-lg border border-border bg-card p-6 space-y-2">
              <h3 className="font-semibold text-card-foreground">Monthly Income</h3>
              <p className="text-3xl font-bold tabular-nums text-success">+$5,234.00</p>
              <p className="text-sm text-muted-foreground">This month</p>
            </div>

            <div className="rounded-lg border border-border bg-card p-6 space-y-2">
              <h3 className="font-semibold text-card-foreground">Outstanding Loan</h3>
              <p className="text-3xl font-bold tabular-nums text-destructive">-$12,450.00</p>
        ...
        {/* Badges */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-foreground">Badges & Status</h2>
        ...
        {/* Financial Data */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold text-foreground">Financial Data Display</h2>
          ...
          <div className="rounded-lg border border-border bg-card">
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b border-border">
                  <td className="px-6 py-4 text-sm text-foreground">Jan 10, 2026</td>
                  <td className="px-6 py-4 text-sm text-foreground">Salary Deposit</td>
                ...
                <tr className="border-b border-border">
                  <td className="px-6 py-4 text-sm text-foreground">Jan 9, 2026</td>
                  <td className="px-6 py-4 text-sm text-foreground">Loan Payment</td>
                ...
                <tr className="border-b border-border">
                  <td className="px-6 py-4 text-sm text-foreground">Jan 8, 2026</td>
                  <td className="px-6 py-4 text-sm text-foreground">Transfer to Savings</td>
        ...
        <section className="rounded-lg border border-border bg-muted p-6">
          ...
          <p className="text-sm text-muted-foreground">
            To toggle dark mode, add or remove the <code className="rounded bg-background px-1 py-0.5 font-mono text-xs">dark</code> class
            from the <code className="rounded bg-background px-1 py-0.5 font-mono text-xs">html</code> element.
            The theme automatically adjusts all colors for optimal visibility and reduced eye strain.
          </p>
        </section>
      </div>
    </div>
